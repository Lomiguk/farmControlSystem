...
(
    ...
    collected_value float4 DEFAULT 0,
    is_done         bool   DEFAULT false,
    is_aborted      bool   DEFAULT false,
...
COMMENT ON COLUMN task.collected_value IS 'Work done';
COMMENT ON COLUMN task.is_done IS 'Flag - is the task completed';
COMMENT ON COLUMN task.is_aborted IS 'Flag - is the task aborted';